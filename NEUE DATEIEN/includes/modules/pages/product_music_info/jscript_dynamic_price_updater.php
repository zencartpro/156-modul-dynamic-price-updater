<?php
/**
 * @package Dynamic Price Updater for Zen Cart German 1.5.6
 * @copyright Dan Parry (Chrome) / Erik Kerkhoven (Design75) / mc12345678
 * @copyright Copyright 2003-2019 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: jscript_dynamic_price_updater.php 2019-09-27 14:54:51Z webchills $
 */
...
objXHR.prototype.getData = function(strMode, resFunc, combinedData) { // send a DPURequest to the server in either GET or POST
  ...
  if (((typeof zcJS === "undefined" || !zcJS) ? this.XHR : zcJS)) {
    if (typeof zcJS === "undefined" || !zcJS) {
      ...
      this.XHR.open(strMode.toLowerCase(), theURL + "<?php echo zen_decode_specialchars(substr(zen_href_link('ajax.php', zen_get_all_get_params(array('action','pid')) . 'act=DPU_Ajax&method=dpu_update', $request_type, true, true, true), strlen(($request_type == 'SSL' ? HTTPS_SERVER . DIR_WS_HTTPS_CATALOG : HTTP_SERVER . DIR_WS_CATALOG)) + strlen($theURL))); ?>" + (strMode.toLowerCase() === "get" ? "&" + this.compileRequest() : ""), true);
...
/*                        this.XHR.open(strMode.toLowerCase(), this.url+"?act=DPU_Ajax&method=dpu_update"+(strMode.toLowerCase() == "get" ? "&" + this.compileRequest() : ""), true);*/
      ...
      var option = {
          url: theURL + "<?php echo zen_decode_specialchars(substr(zen_href_link('ajax.php', zen_get_all_get_params(array('action','pid')) . 'act=DPU_Ajax&method=dpu_update', $request_type, true, true, true), strlen(($request_type == 'SSL' ? HTTPS_SERVER . DIR_WS_HTTPS_CATALOG : HTTP_SERVER . DIR_WS_CATALOG)) + strlen($theURL))); ?>",
